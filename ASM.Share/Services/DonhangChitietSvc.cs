...
namespace ASM.Share.Models
{
    public interface IDonhangChitietSvc
    {
        ...
        Task<List<DonhangChitiet>> GetDonhangChitietbyDonhangAsync(int donHangId);
    }
    ...
    public class DonhangChitietSvc : IDonhangChitietSvc
    {
        ...
        public async Task<List<DonhangChitiet>> GetDonhangChitietbyDonhangAsync(int donHangId)
        {
            return await _context.DonhangChitiets.Where(d => d.DonhangID == donHangId).ToListAsync();
        }
