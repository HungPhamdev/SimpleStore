...
{    
    public interface IDonhangSvc
    {
        ...
        Task<List<Donhang>> FindDonHangAllAsync(double tongTien);
        ...
        Task<int> EditDonhangAsync(int id, Donhang donhang);
    }
    public class DonhangSvc : IDonhangSvc
    {
        ...
        public async Task<List<Donhang>> FindDonHangAllAsync(double tongTien)
        {
            return await _context.Donhangs.Where(x => x.Tongtien == tongTien).ToListAsync();
        }
        ...
        public async Task<int> EditDonhangAsync(int id, Donhang donhang)
        {
            int ret = 0;
            try
            {
