...
namespace ASM.API.Controllers
{
    ...
    public class DonhangChitietController : ControllerBase
    {
        ...
        //[HttpGet]
        //public async Task<ActionResult<IEnumerable<DonhangChitiet>>> GetDonhangChitietbyDonhang(int donHangId)
        //{
        //    return await _donhangChitietSvc.GetDonhangChitietbyDonhangAsync(donHangId);
        //}
    }
}
